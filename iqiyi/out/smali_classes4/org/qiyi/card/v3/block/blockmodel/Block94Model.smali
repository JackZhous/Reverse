.class public Lorg/qiyi/card/v3/block/blockmodel/Block94Model;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "<",
        "Lorg/qiyi/card/v3/block/blockmodel/Block94Model$ViewHolder;",
        ">;"
    }
.end annotation
...
# virtual methods
.method public a(Lorg/qiyi/basecard/v3/viewholder/RowViewHolder;Lorg/qiyi/card/v3/block/blockmodel/Block94Model$ViewHolder;Lorg/qiyi/basecard/v3/helper/ICardHelper;)V
    .locals 1
    ...
    iget-object v0, p0, Lorg/qiyi/card/v3/block/blockmodel/Block94Model;->mBlock:Lorg/qiyi/basecard/v3/data/component/Block;
...
.method public ce(Landroid/view/View;Lorg/qiyi/pluginlibrary/utils/ResourcesToolForPlugin;)Lorg/qiyi/card/v3/block/blockmodel/Block94Model$ViewHolder;
    .locals 1

    new-instance v0, Lorg/qiyi/card/v3/block/blockmodel/Block94Model$ViewHolder;

    invoke-direct {v0, p0, p1, p2}, Lorg/qiyi/card/v3/block/blockmodel/Block94Model$ViewHolder;-><init>(Lorg/qiyi/card/v3/block/blockmodel/Block94Model;Landroid/view/View;Lorg/qiyi/pluginlibrary/utils/ResourcesToolForPlugin;)V
...
.method public synthetic onBindViewData(Lorg/qiyi/basecard/v3/viewholder/RowViewHolder;Lorg/qiyi/basecard/v3/viewholder/BlockViewHolder;Lorg/qiyi/basecard/v3/helper/ICardHelper;)V
    ...
    check-cast p2, Lorg/qiyi/card/v3/block/blockmodel/Block94Model$ViewHolder;

    invoke-virtual {p0, p1, p2, p3}, Lorg/qiyi/card/v3/block/blockmodel/Block94Model;->a(Lorg/qiyi/basecard/v3/viewholder/RowViewHolder;Lorg/qiyi/card/v3/block/blockmodel/Block94Model$ViewHolder;Lorg/qiyi/basecard/v3/helper/ICardHelper;)V
...
.method public onCreateView(Landroid/view/ViewGroup;Lorg/qiyi/pluginlibrary/utils/ResourcesToolForPlugin;)Landroid/view/View;
    ...
    invoke-virtual {v2, v5}, Lorg/qiyi/basecard/common/widget/MetaView;->setId(I)V
    ...
    iget v2, p0, Lorg/qiyi/card/v3/block/blockmodel/Block94Model;->mPosition:I

    invoke-virtual {p0, v0, v2}, Lorg/qiyi/card/v3/block/blockmodel/Block94Model;->getBlockWidth(Landroid/content/Context;I)I

    move-result v0

    iget v2, p0, Lorg/qiyi/card/v3/block/blockmodel/Block94Model;->mLeftBlockViewId:I

    invoke-virtual {p0, v0, v2}, Lorg/qiyi/card/v3/block/blockmodel/Block94Model;->getParams(II)Landroid/widget/RelativeLayout$LayoutParams;
...
.method public synthetic onCreateViewHolder(Landroid/view/View;Lorg/qiyi/pluginlibrary/utils/ResourcesToolForPlugin;)Lorg/qiyi/basecard/v3/viewholder/BlockViewHolder;
    ...
    invoke-virtual {p0, p1, p2}, Lorg/qiyi/card/v3/block/blockmodel/Block94Model;->ce(Landroid/view/View;Lorg/qiyi/pluginlibrary/utils/ResourcesToolForPlugin;)Lorg/qiyi/card/v3/block/blockmodel/Block94Model$ViewHolder;
