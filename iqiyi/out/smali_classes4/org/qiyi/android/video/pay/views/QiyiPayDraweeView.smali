.class public Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;
...
.field public static mAttirbuteHelper:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "<",
            "Lorg/qiyi/android/video/pay/views/lpt3;",
            ">;>;"
        }
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->sDm:Landroid/util/DisplayMetrics;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->mAttirbuteHelper:Ljava/util/Map;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v0, p0, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->mMaxWidth:I

    iput v0, p0, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->mMaxHeight:I

    const/4 v0, 0x0

    iput-boolean v0, p0, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->mInitialised:Z
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->fixWrapContent(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method private fixWrapContent(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    :cond_1
    :try_start_0
    invoke-virtual {p0}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->getScaleType()Landroid/widget/ImageView$ScaleType;
    ...
    invoke-virtual {p0}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->getHierarchy()Lcom/facebook/drawee/interfaces/DraweeHierarchy;

    move-result-object v0

    check-cast v0, Lcom/facebook/drawee/generic/GenericDraweeHierarchy;

    invoke-direct {p0, v2}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->transformScaleType(Landroid/widget/ImageView$ScaleType;)Lcom/facebook/drawee/drawable/ScalingUtils$ScaleType;
    ...
    invoke-virtual {p0, v0, v1}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->dv(Landroid/content/Context;Ljava/lang/String;)Lorg/qiyi/android/video/pay/views/lpt3;
    ...
    invoke-virtual {v4, v1}, Lorg/qiyi/android/video/pay/views/lpt3;->QQ(Ljava/lang/String;)[I
    ...
    invoke-virtual {v4, v0}, Lorg/qiyi/android/video/pay/views/lpt3;->QR(Ljava/lang/String;)I
    ...
    invoke-virtual {v4, v0}, Lorg/qiyi/android/video/pay/views/lpt3;->QQ(Ljava/lang/String;)[I
    ...
    invoke-virtual {v4, v2}, Lorg/qiyi/android/video/pay/views/lpt3;->QR(Ljava/lang/String;)I
    ...
    invoke-virtual {v4, v5}, Lorg/qiyi/android/video/pay/views/lpt3;->QR(Ljava/lang/String;)I
    ...
    iput v0, p0, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->resourceImageWidth:I
    ...
    iput v0, p0, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->resourceImageHeight:I
...
.method private getResizeOption()Lcom/facebook/imagepipeline/common/ResizeOptions;
    ...
    invoke-virtual {p0}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->getLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    :cond_0
    iget v0, p0, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->mMaxWidth:I

    sget-object v1, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->sDm:Landroid/util/DisplayMetrics;

    iget v1, v1, Landroid/util/DisplayMetrics;->widthPixels:I

    if-le v0, v1, :cond_1

    sget-object v0, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->sDm:Landroid/util/DisplayMetrics;
    ...
    :cond_2
    iget v0, p0, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->mMaxHeight:I

    sget-object v2, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->sDm:Landroid/util/DisplayMetrics;
...
.method private transformScaleType(Landroid/widget/ImageView$ScaleType;)Lcom/facebook/drawee/drawable/ScalingUtils$ScaleType;
    ...
    :cond_1
    sget-object v1, Lorg/qiyi/android/video/pay/views/lpt2;->$SwitchMap$android$widget$ImageView$ScaleType:[I
...
# virtual methods
.method protected dv(Landroid/content/Context;Ljava/lang/String;)Lorg/qiyi/android/video/pay/views/lpt3;
    .locals 4
    ...
    sget-object v0, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->mAttirbuteHelper:Ljava/util/Map;
    ...
    new-instance v0, Lorg/qiyi/android/video/pay/views/lpt3;

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1, p2}, Lorg/qiyi/android/video/pay/views/lpt3;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    new-instance v1, Ljava/lang/ref/WeakReference;

    invoke-direct {v1, v0}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    sget-object v2, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->mAttirbuteHelper:Ljava/util/Map;
    ...
    check-cast v0, Lorg/qiyi/android/video/pay/views/lpt3;
...
.method protected notSupportParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/util/Pair;
    ...
    invoke-virtual {p0}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->getAspectRatio()F
    ...
    invoke-virtual {p0}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->getMeasuredWidth()I

    move-result v0

    invoke-virtual {p0}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->getSuggestedMinimumWidth()I
    ...
    invoke-virtual {p0}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->getMeasuredHeight()I

    move-result v3

    invoke-virtual {p0}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->getSuggestedMinimumHeight()I
...
.method public setImageURI(Landroid/net/Uri;Lcom/facebook/drawee/controller/ControllerListener;)V
    ...
    invoke-virtual {p0, p1, v0, p2}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->setImageURI(Landroid/net/Uri;Ljava/lang/Object;Lcom/facebook/drawee/controller/ControllerListener;)V
...
.method public setImageURI(Landroid/net/Uri;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->setImageURI(Landroid/net/Uri;Ljava/lang/Object;Lcom/facebook/drawee/controller/ControllerListener;)V
...
.method public setImageURI(Landroid/net/Uri;Ljava/lang/Object;Lcom/facebook/drawee/controller/ControllerListener;)V
    ...
    new-instance v2, Lorg/qiyi/android/video/pay/views/lpt1;

    invoke-direct {v2, p0, v1, v0}, Lorg/qiyi/android/video/pay/views/lpt1;-><init>(Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;Ljava/lang/String;Ljava/lang/ref/WeakReference;)V
    ...
    invoke-virtual {p0}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->getCallerViewContext()Landroid/content/Context;
    ...
    invoke-direct {p0}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->getResizeOption()Lcom/facebook/imagepipeline/common/ResizeOptions;
    ...
    invoke-virtual {p0}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->getController()Lcom/facebook/drawee/interfaces/DraweeController;
    ...
    invoke-virtual {p0, v0}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->setController(Lcom/facebook/drawee/interfaces/DraweeController;)V
...
.method public setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {p0, p1}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->notSupportParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/util/Pair;
    ...
    iget v0, p0, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->resourceImageWidth:I
    ...
    iget v0, p0, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->resourceImageHeight:I
...
.method public setMaxHeight(I)V
    ...
    iput p1, p0, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->mMaxHeight:I
...
.method public setMaxWidth(I)V
    ...
    iput p1, p0, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->mMaxWidth:I
...
.method public setScaleType(Landroid/widget/ImageView$ScaleType;)V
    ...
    iget-boolean v0, p0, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->mInitialised:Z

    if-eqz v0, :cond_0

    invoke-direct {p0, p1}, Lorg/qiyi/android/video/pay/views/QiyiPayDraweeView;->transformScaleType(Landroid/widget/ImageView$ScaleType;)Lcom/facebook/drawee/drawable/ScalingUtils$ScaleType;
