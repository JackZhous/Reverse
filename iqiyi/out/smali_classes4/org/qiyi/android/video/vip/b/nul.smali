.class public Lorg/qiyi/android/video/vip/b/nul;
...
.field private isE:Lorg/qiyi/basecore/card/event/EventData;

.field private isF:Lorg/qiyi/basecore/card/event/EventData;

.field private isG:Lorg/qiyi/basecore/card/event/EventData;
...
.method public constructor <init>(Lorg/qiyi/android/video/vip/a/com5;Lorg/qiyi/android/video/vip/model/b/com4;)V
    ...
    iput v0, p0, Lorg/qiyi/android/video/vip/b/nul;->isB:I

    const/4 v0, -0x1

    iput v0, p0, Lorg/qiyi/android/video/vip/b/nul;->isC:I

    new-instance v0, Lorg/qiyi/android/video/vip/b/prn;

    invoke-direct {v0, p0}, Lorg/qiyi/android/video/vip/b/prn;-><init>(Lorg/qiyi/android/video/vip/b/nul;)V

    iput-object v0, p0, Lorg/qiyi/android/video/vip/b/nul;->isD:Landroid/content/BroadcastReceiver;

    new-instance v0, Ljava/lang/ref/WeakReference;

    invoke-direct {v0, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Lorg/qiyi/android/video/vip/b/nul;->mView:Ljava/lang/ref/WeakReference;

    iput-object p2, p0, Lorg/qiyi/android/video/vip/b/nul;->isz:Lorg/qiyi/android/video/vip/model/b/com4;

    invoke-interface {p1}, Lorg/qiyi/android/video/vip/a/com5;->cKm()Lorg/qiyi/android/video/pagemgr/BaseUIPageActivity;

    move-result-object v0

    const/4 v1, 0x0

    invoke-static {v0, v1}, Lorg/qiyi/android/card/com4;->f(Landroid/content/Context;Ljava/lang/Object;)Lorg/qiyi/basecore/card/event/CardListEventListener;

    move-result-object v0

    iput-object v0, p0, Lorg/qiyi/android/video/vip/b/nul;->dun:Lorg/qiyi/basecore/card/event/CardListEventListener;
...
.method private Ts(Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lorg/qiyi/android/video/vip/b/nul;->isz:Lorg/qiyi/android/video/vip/model/b/com4;

    new-instance v1, Lorg/qiyi/android/video/vip/b/lpt1;

    invoke-direct {v1, p0, p1}, Lorg/qiyi/android/video/vip/b/lpt1;-><init>(Lorg/qiyi/android/video/vip/b/nul;Ljava/lang/String;)V
...
.method private Tt(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKI()Lorg/qiyi/android/video/pagemgr/BaseUIPageActivity;
...
.method static synthetic a(Lorg/qiyi/android/video/vip/b/nul;I)I
    .locals 0

    iput p1, p0, Lorg/qiyi/android/video/vip/b/nul;->isB:I

    return p1
.end method

.method static synthetic a(Lorg/qiyi/android/video/vip/b/nul;Lorg/qiyi/basecore/card/event/EventData;)Lorg/qiyi/basecore/card/event/EventData;
    .locals 0

    iput-object p1, p0, Lorg/qiyi/android/video/vip/b/nul;->isE:Lorg/qiyi/basecore/card/event/EventData;

    return-object p1
.end method

.method static synthetic a(Lorg/qiyi/android/video/vip/b/nul;)V
    .locals 0

    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKH()V

    return-void
.end method

.method static synthetic a(Lorg/qiyi/android/video/vip/b/nul;Ljava/util/List;)V
    .locals 0

    invoke-direct {p0, p1}, Lorg/qiyi/android/video/vip/b/nul;->gA(Ljava/util/List;)V

    return-void
.end method

.method static synthetic b(Lorg/qiyi/android/video/vip/b/nul;)Lorg/qiyi/android/video/vip/view/adapter/VipHomePagerAdapter;
    .locals 1

    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKJ()Lorg/qiyi/android/video/vip/view/adapter/VipHomePagerAdapter;
...
.method static synthetic b(Lorg/qiyi/android/video/vip/b/nul;Lorg/qiyi/basecore/card/event/EventData;)Lorg/qiyi/basecore/card/event/EventData;
    .locals 0

    iput-object p1, p0, Lorg/qiyi/android/video/vip/b/nul;->isG:Lorg/qiyi/basecore/card/event/EventData;
...
.method private bgv()V
    ...
    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->getViewPager()Landroid/support/v4/view/ViewPager;
...
.method static synthetic c(Lorg/qiyi/android/video/vip/b/nul;Lorg/qiyi/basecore/card/event/EventData;)Lorg/qiyi/basecore/card/event/EventData;
    .locals 0

    iput-object p1, p0, Lorg/qiyi/android/video/vip/b/nul;->isF:Lorg/qiyi/basecore/card/event/EventData;

    return-object p1
.end method

.method static synthetic c(Lorg/qiyi/android/video/vip/b/nul;)Z
    .locals 1

    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKK()Z
...
.method private cKH()V
    ...
    new-instance v1, Lorg/qiyi/android/video/vip/b/com8;

    invoke-direct {v1, p0}, Lorg/qiyi/android/video/vip/b/com8;-><init>(Lorg/qiyi/android/video/vip/b/nul;)V

    invoke-static {v0, v1}, Lorg/qiyi/android/video/ui/com5;->a(Ljava/lang/String;Lorg/qiyi/android/video/ui/lpt2;)V

    const-string/jumbo v0, "vip"

    new-instance v1, Lorg/qiyi/android/video/vip/b/com9;

    invoke-direct {v1, p0}, Lorg/qiyi/android/video/vip/b/com9;-><init>(Lorg/qiyi/android/video/vip/b/nul;)V
...
.method private cKI()Lorg/qiyi/android/video/pagemgr/BaseUIPageActivity;
    ...
    invoke-virtual {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKU()Lorg/qiyi/android/video/vip/a/com5;
...
.method private cKL()V
    ...
    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->getTransformData()Ljava/lang/Object;
...
.method private cKN()V
    ...
    iget v0, p0, Lorg/qiyi/android/video/vip/b/nul;->isC:I
    ...
    iget v1, p0, Lorg/qiyi/android/video/vip/b/nul;->isC:I
...
.method private cKQ()V
    ...
    :cond_0
    iget-object v0, p0, Lorg/qiyi/android/video/vip/b/nul;->eeA:Landroid/os/Handler;

    new-instance v1, Lorg/qiyi/android/video/vip/b/com2;

    invoke-direct {v1, p0}, Lorg/qiyi/android/video/vip/b/com2;-><init>(Lorg/qiyi/android/video/vip/b/nul;)V
    ...
    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKN()V
...
.method private cKR()V
    ...
    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKn()Lorg/qiyi/basecore/widget/PagerSlidingTabStrip;
    ...
    new-instance v2, Lorg/qiyi/android/video/vip/b/com3;

    invoke-direct {v2, p0, v0}, Lorg/qiyi/android/video/vip/b/com3;-><init>(Lorg/qiyi/android/video/vip/b/nul;Lorg/qiyi/basecore/widget/PagerSlidingTabStrip;)V
...
.method private cKg()V
    ...
    iget-object v1, p0, Lorg/qiyi/android/video/vip/b/nul;->eeA:Landroid/os/Handler;

    new-instance v2, Lorg/qiyi/android/video/vip/b/lpt2;

    invoke-direct {v2, p0, v0}, Lorg/qiyi/android/video/vip/b/lpt2;-><init>(Lorg/qiyi/android/video/vip/b/nul;Lorg/qiyi/android/video/vip/a/com5;)V
...
.method private cph()V
    ...
    new-instance v1, Lorg/qiyi/android/video/vip/b/com7;

    invoke-direct {v1, p0}, Lorg/qiyi/android/video/vip/b/com7;-><init>(Lorg/qiyi/android/video/vip/b/nul;)V
...
.method private cpr()V
    ...
    new-instance v1, Lorg/qiyi/android/video/vip/b/com6;

    invoke-direct {v1, p0}, Lorg/qiyi/android/video/vip/b/com6;-><init>(Lorg/qiyi/android/video/vip/b/nul;)V
...
.method static synthetic d(Lorg/qiyi/android/video/vip/b/nul;)Landroid/support/v4/view/ViewPager;
    .locals 1
...
.method static synthetic e(Lorg/qiyi/android/video/vip/b/nul;)I
    .locals 1

    iget v0, p0, Lorg/qiyi/android/video/vip/b/nul;->isB:I

    return v0
.end method

.method static synthetic f(Lorg/qiyi/android/video/vip/b/nul;)V
    .locals 0

    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKg()V

    return-void
.end method

.method static synthetic g(Lorg/qiyi/android/video/vip/b/nul;)V
    .locals 0

    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKQ()V
...
.method private gA(Ljava/util/List;)V
    ...
    :cond_4
    iput-object p1, p0, Lorg/qiyi/android/video/vip/b/nul;->isA:Ljava/util/List;
    ...
    invoke-direct {p0, v1}, Lorg/qiyi/android/video/vip/b/nul;->Tt(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
...
.method static synthetic h(Lorg/qiyi/android/video/vip/b/nul;)V
    .locals 0

    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKR()V

    return-void
.end method

.method static synthetic i(Lorg/qiyi/android/video/vip/b/nul;)Lorg/qiyi/basecore/widget/PagerSlidingTabStrip;
    .locals 1
...
.method static synthetic j(Lorg/qiyi/android/video/vip/b/nul;)Lorg/qiyi/android/video/pagemgr/BaseUIPageActivity;
    .locals 1
...
.method public MA(I)V
    ...
    invoke-virtual {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKT()Lorg/qiyi/android/video/pagemgr/BaseUIPageActivity;

    move-result-object v1

    iget-object v0, p0, Lorg/qiyi/android/video/vip/b/nul;->isA:Ljava/util/List;
...
.method public Mx(I)V
    ...
    iget v1, p0, Lorg/qiyi/android/video/vip/b/nul;->isB:I
    ...
    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->cFy()Z
...
.method public Y(Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Lorg/qiyi/android/video/vip/b/nul;->eeA:Landroid/os/Handler;

    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->cpr()V

    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->cph()V
...
.method public cKO()V
    ...
    iget-object v1, p0, Lorg/qiyi/android/video/vip/b/nul;->isz:Lorg/qiyi/android/video/vip/model/b/com4;
    ...
    invoke-direct {p0, v0}, Lorg/qiyi/android/video/vip/b/nul;->Ts(Ljava/lang/String;)V
...
.method public cKP()V
    ...
    new-instance v2, Lorg/qiyi/android/video/vip/b/lpt3;

    invoke-direct {v2, p0, v0}, Lorg/qiyi/android/video/vip/b/lpt3;-><init>(Lorg/qiyi/android/video/vip/b/nul;Ljava/lang/String;)V
...
.method public cKS()V
    ...
    invoke-static {}, Lorg/qiyi/android/video/vip/util/VipHomeUtils;->cKW()Z
    ...
    new-instance v1, Lorg/qiyi/android/video/vip/b/com4;

    invoke-direct {v1, p0}, Lorg/qiyi/android/video/vip/b/com4;-><init>(Lorg/qiyi/android/video/vip/b/nul;)V

    invoke-virtual {v0, v1}, Lorg/qiyi/android/video/vip/model/b/com4;->d(Lorg/qiyi/android/video/vip/model/b/com2;)V
...
.method protected cKU()Lorg/qiyi/android/video/vip/a/com5;
    ...
    iget-object v0, p0, Lorg/qiyi/android/video/vip/b/nul;->mView:Ljava/lang/ref/WeakReference;
...
.method public cKb()V
    ...
    iget-object v0, p0, Lorg/qiyi/android/video/vip/b/nul;->dun:Lorg/qiyi/basecore/card/event/CardListEventListener;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lorg/qiyi/android/video/vip/b/nul;->isE:Lorg/qiyi/basecore/card/event/EventData;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lorg/qiyi/android/video/vip/b/nul;->dun:Lorg/qiyi/basecore/card/event/CardListEventListener;

    iget-object v3, p0, Lorg/qiyi/android/video/vip/b/nul;->isE:Lorg/qiyi/basecore/card/event/EventData;
...
.method public cKc()V
    ...
    iget-object v0, p0, Lorg/qiyi/android/video/vip/b/nul;->isG:Lorg/qiyi/basecore/card/event/EventData;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lorg/qiyi/android/video/vip/b/nul;->dun:Lorg/qiyi/basecore/card/event/CardListEventListener;

    iget-object v3, p0, Lorg/qiyi/android/video/vip/b/nul;->isG:Lorg/qiyi/basecore/card/event/EventData;
...
.method public cKd()V
    ...
    iget-object v0, p0, Lorg/qiyi/android/video/vip/b/nul;->isF:Lorg/qiyi/basecore/card/event/EventData;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lorg/qiyi/android/video/vip/b/nul;->dun:Lorg/qiyi/basecore/card/event/CardListEventListener;

    iget-object v3, p0, Lorg/qiyi/android/video/vip/b/nul;->isF:Lorg/qiyi/basecore/card/event/EventData;
...
.method public cpi()V
    ...
    new-instance v2, Lorg/qiyi/android/video/vip/b/com1;

    invoke-direct {v2, p0, v0}, Lorg/qiyi/android/video/vip/b/com1;-><init>(Lorg/qiyi/android/video/vip/b/nul;Lorg/qiyi/android/video/vip/a/com5;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    new-instance v0, Lorg/qiyi/android/video/vip/b/com5;

    invoke-direct {v0, p0}, Lorg/qiyi/android/video/vip/b/com5;-><init>(Lorg/qiyi/android/video/vip/b/nul;)V

    iput-object v0, p0, Lorg/qiyi/android/video/vip/b/nul;->userTracker:Lorg/qiyi/video/module/event/passport/UserTracker;
...
.method public onDestroy()V
    ...
    iget-object v0, p0, Lorg/qiyi/android/video/vip/b/nul;->userTracker:Lorg/qiyi/video/module/event/passport/UserTracker;
    ...
    iget-object v1, p0, Lorg/qiyi/android/video/vip/b/nul;->isD:Landroid/content/BroadcastReceiver;
...
.method public onPause()V
    ...
    :cond_1
    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKM()V

    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKB()V
...
.method public onResume()V
    ...
    invoke-interface {v0, v2}, Lorg/qiyi/android/video/vip/a/com5;->wZ(Z)V
    ...
    :cond_0
    invoke-virtual {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKe()V

    :cond_1
    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKL()V

    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKN()V

    invoke-direct {p0}, Lorg/qiyi/android/video/vip/b/nul;->bgv()V
...
.method public onViewCreated(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKO()V

    invoke-virtual {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKP()V

    invoke-virtual {p0}, Lorg/qiyi/android/video/vip/b/nul;->cKS()V
    ...
    iget-object v2, p0, Lorg/qiyi/android/video/vip/b/nul;->isD:Landroid/content/BroadcastReceiver;
