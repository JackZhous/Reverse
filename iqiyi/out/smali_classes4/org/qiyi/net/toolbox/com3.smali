.class public Lorg/qiyi/net/toolbox/com3;
...
.method public static a([Ljava/io/InputStream;Ljava/io/InputStream;Ljava/lang/String;)Ljavax/net/ssl/SSLSocketFactory;
    ...
    :try_start_0
    invoke-static {p0}, Lorg/qiyi/net/toolbox/com3;->c([Ljava/io/InputStream;)[Ljavax/net/ssl/TrustManager;

    move-result-object v2

    invoke-static {p1, p2}, Lorg/qiyi/net/toolbox/com3;->a(Ljava/io/InputStream;Ljava/lang/String;)[Ljavax/net/ssl/KeyManager;
    ...
    new-instance v1, Lorg/qiyi/net/toolbox/com5;

    invoke-static {v2}, Lorg/qiyi/net/toolbox/com3;->b([Ljavax/net/ssl/TrustManager;)Ljavax/net/ssl/X509TrustManager;

    move-result-object v2

    invoke-direct {v1, v2}, Lorg/qiyi/net/toolbox/com5;-><init>(Ljavax/net/ssl/X509TrustManager;)V

    sget-boolean v2, Lorg/qiyi/net/aux;->DEBUG:Z

    if-eqz v2, :cond_0

    const-string/jumbo v2, "trustManagers is not null!"

    const/4 v5, 0x0

    new-array v5, v5, [Ljava/lang/Object;

    invoke-static {v2, v5}, Lorg/qiyi/net/aux;->d(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v3, v2, v1}, Ljavax/net/ssl/SSLContext;->init([Ljavax/net/ssl/KeyManager;[Ljavax/net/ssl/TrustManager;Ljava/security/SecureRandom;)V
    ...
    :cond_1
    new-instance v1, Lorg/qiyi/net/toolbox/com6;

    const/4 v2, 0x0

    invoke-direct {v1, v2}, Lorg/qiyi/net/toolbox/com6;-><init>(Lorg/qiyi/net/toolbox/com4;)V

    sget-boolean v2, Lorg/qiyi/net/aux;->DEBUG:Z

    if-eqz v2, :cond_0

    const-string/jumbo v2, "trustManagers is  null!"
...
.method static synthetic c([Ljavax/net/ssl/TrustManager;)Ljavax/net/ssl/X509TrustManager;
    ...
    invoke-static {p0}, Lorg/qiyi/net/toolbox/com3;->b([Ljavax/net/ssl/TrustManager;)Ljavax/net/ssl/X509TrustManager;
