.class public Lcom/iqiyi/publisher/h/lpt3;
.super Ljava/lang/Object;


# direct methods
.method public static a(Landroid/content/Context;Ljava/util/List;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    .locals 3
    ...
    :cond_0
    invoke-static {p0, p1, p2, v1}, Lcom/iqiyi/publisher/h/lpt3;->a(Landroid/content/Context;Ljava/util/List;Ljava/lang/String;[Ljava/lang/String;)Ljava/util/List;
...
.method public static a(Landroid/content/Context;Ljava/util/List;Ljava/lang/String;[Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p0, p2}, Lcom/iqiyi/publisher/h/lpt3;->aA(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3, v0, v1, v4}, Lcom/iqiyi/publisher/h/lpt3;->b(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
.method public static aA(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v1, "selfsource"
    ...
    :cond_0
    invoke-static {p0}, Lcom/iqiyi/publisher/h/lpt3;->gy(Landroid/content/Context;)V
...
.method public static aB(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v0, "selfsource"
    ...
    const-string/jumbo v1, "PublisherFileUtils"
    ...
    const-string/jumbo v4, "getMaterialDownloadDir "
...
.method public static aC(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v0, "selfmade"
    ...
    const-string/jumbo v1, "transout.mp4"
    ...
    const-string/jumbo v1, "_transcode.mp4"
    ...
    const-string/jumbo v1, "/trancode.mp4"
...
.method public static aE(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v3, "getOutFilePathRelatively, outFilePath:"
...
.method public static aEt()J
    ...
    const-string/jumbo v4, "PublisherFileUtils"
    ...
    const-string/jumbo v7, "ExternalStorage available size is : "
    ...
    :cond_0
    const-string/jumbo v0, "PublisherFileUtils"

    const-string/jumbo v1, "ExternalStorage cannot be used !"
...
.method public static aF(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-static {p0}, Lcom/iqiyi/paopao/middlecommon/d/ab;->fO(Landroid/content/Context;)Ljava/io/File;
...
.method public static aH(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v3, "move file from"
...
.method public static b(Landroid/content/Context;Ljava/util/List;Ljava/lang/String;[Ljava/lang/String;)Ljava/util/List;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p2}, Lcom/iqiyi/publisher/h/lpt3;->aB(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
...
.method public static gA(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-string/jumbo v1, "createSelfMadeTempFile() BEGIN"
    ...
    const-string/jumbo v3, "\'IQIYI\'_yyyyMMdd_HHmmss"
    ...
    const-string/jumbo v1, "selfmade"
    ...
    const-string/jumbo v3, "createSelfMadeTempFile() VideoFile:"
...
.method private static gy(Landroid/content/Context;)V
    .locals 3
    ...
    invoke-static {v1}, Lcom/iqiyi/publisher/h/lpt3;->sE(Ljava/lang/String;)Ljava/util/List;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static hK(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/iqiyi/paopao/base/utils/b/aux;->hK(Ljava/lang/String;)Ljava/lang/String;
...
.method private static sE(Ljava/lang/String;)Ljava/util/List;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v0, Lcom/iqiyi/publisher/h/lpt4;

    invoke-direct {v0}, Lcom/iqiyi/publisher/h/lpt4;-><init>()V
...
.method public static sF(Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lcom/iqiyi/publisher/h/lpt3;->deleteFile(Ljava/lang/String;)Z
    ...
    :cond_2
    invoke-static {p0}, Lcom/iqiyi/publisher/h/lpt3;->sG(Ljava/lang/String;)Z
...
.method private static sG(Ljava/lang/String;)Z
    ...
    invoke-static {v2}, Lcom/iqiyi/publisher/h/lpt3;->deleteFile(Ljava/lang/String;)Z
    ...
    invoke-static {v2}, Lcom/iqiyi/publisher/h/lpt3;->sG(Ljava/lang/String;)Z
