.class Lcom/qiyi/card/viewmodel/StarListTopThreeVoteCardModel$ViewHolder;
.super Lcom/qiyi/card/viewmodel/StarListTopThreeCardModel$ViewHolder;
...
# instance fields
.field status:Landroid/view/View;
...
.method public constructor <init>(Landroid/view/View;Lorg/qiyi/pluginlibrary/utils/ResourcesToolForPlugin;)V
    ...
    invoke-direct {p0, p1, p2}, Lcom/qiyi/card/viewmodel/StarListTopThreeCardModel$ViewHolder;-><init>(Landroid/view/View;Lorg/qiyi/pluginlibrary/utils/ResourcesToolForPlugin;)V

    const-string/jumbo v0, "status"

    invoke-virtual {p0, v0}, Lcom/qiyi/card/viewmodel/StarListTopThreeVoteCardModel$ViewHolder;->findViewById(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/view/View;

    iput-object v0, p0, Lcom/qiyi/card/viewmodel/StarListTopThreeVoteCardModel$ViewHolder;->status:Landroid/view/View;

    return-void
.end method

.method static synthetic access$000(Lcom/qiyi/card/viewmodel/StarListTopThreeVoteCardModel$ViewHolder;Lorg/qiyi/basecore/card/model/unit/EVENT;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/qiyi/card/viewmodel/StarListTopThreeVoteCardModel$ViewHolder;->changeButtonStatus(Lorg/qiyi/basecore/card/model/unit/EVENT;)V
...
.method private changeButtonStatus(Lorg/qiyi/basecore/card/model/unit/EVENT;)V
    ...
    iget-object v1, p0, Lcom/qiyi/card/viewmodel/StarListTopThreeVoteCardModel$ViewHolder;->btnHitList:Lorg/qiyi/basecore/widget/OuterFrameTextView;
    ...
    invoke-virtual {v1, v4, v2}, Lorg/qiyi/basecore/widget/OuterFrameTextView;->setTextSize(IF)V

    if-ne v0, v4, :cond_1

    iget-object v0, p0, Lcom/qiyi/card/viewmodel/StarListTopThreeVoteCardModel$ViewHolder;->btnHitList:Lorg/qiyi/basecore/widget/OuterFrameTextView;

    invoke-virtual {v0, v3}, Lorg/qiyi/basecore/widget/OuterFrameTextView;->Od(I)V

    iget-object v0, p0, Lcom/qiyi/card/viewmodel/StarListTopThreeVoteCardModel$ViewHolder;->btnHitList:Lorg/qiyi/basecore/widget/OuterFrameTextView;

    invoke-static {}, Lcom/qiyi/card/viewmodel/StarListTopThreeVoteCardModel;->access$200()Ljava/lang/String;
...
.method public update(Ljava/lang/String;Landroid/view/View;Ljava/lang/Object;Landroid/os/Bundle;)Z
    ...
    instance-of v0, v0, Lcom/qiyi/card/viewmodel/StarListTopThreeVoteCardModel;

    if-eqz v0, :cond_0

    iget-object v0, p3, Lorg/qiyi/basecore/card/event/EventData;->cardModel:Lorg/qiyi/basecore/card/view/AbstractCardModel;

    check-cast v0, Lcom/qiyi/card/viewmodel/StarListTopThreeVoteCardModel;

    invoke-virtual {v0}, Lcom/qiyi/card/viewmodel/StarListTopThreeVoteCardModel;->getBList()Ljava/util/List;
    ...
    iget-object v2, p0, Lcom/qiyi/card/viewmodel/StarListTopThreeVoteCardModel$ViewHolder;->meta2:Landroid/widget/TextView;
    ...
    invoke-static {}, Lcom/qiyi/card/viewmodel/StarListTopThreeVoteCardModel;->access$100()Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lcom/qiyi/card/viewmodel/StarListTopThreeVoteCardModel$ViewHolder;->setJoined(Lorg/qiyi/basecore/card/model/unit/EVENT;)V
