.class public Lcom/qiyi/card/builder/MovieHotWordCardBuilder;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/qiyi/card/builder/MovieHotWordCardBuilder;

    invoke-direct {v0}, Lcom/qiyi/card/builder/MovieHotWordCardBuilder;-><init>()V

    sput-object v0, Lcom/qiyi/card/builder/MovieHotWordCardBuilder;->instance:Lorg/qiyi/basecore/card/builder/IOptCardBuilder;
...
.method private getCardModelBytype(Ljava/lang/String;Lorg/qiyi/basecore/card/model/Card;Ljava/util/List;Lorg/qiyi/basecore/card/CardModelHolder;)Lcom/qiyi/card/viewmodel/MovieHotWordCardModel;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            ...
            ")",
            "Lcom/qiyi/card/viewmodel/MovieHotWordCardModel;"
        }
    .end annotation
    ...
    :pswitch_3
    new-instance v0, Lcom/qiyi/card/viewmodel/MovieThreeHotWordCardModel;

    iget-object v1, p2, Lorg/qiyi/basecore/card/model/Card;->statistics:Lorg/qiyi/basecore/card/model/statistics/CardStatistics;

    invoke-direct {v0, v1, p3, p4}, Lcom/qiyi/card/viewmodel/MovieThreeHotWordCardModel;-><init>(Lorg/qiyi/basecore/card/model/statistics/CardStatistics;Ljava/util/List;Lorg/qiyi/basecore/card/CardModelHolder;)V

    goto :goto_1

    :pswitch_4
    new-instance v0, Lcom/qiyi/card/viewmodel/MovieTwoHotWordCardModel;

    iget-object v1, p2, Lorg/qiyi/basecore/card/model/Card;->statistics:Lorg/qiyi/basecore/card/model/statistics/CardStatistics;

    invoke-direct {v0, v1, p3, p4}, Lcom/qiyi/card/viewmodel/MovieTwoHotWordCardModel;-><init>(Lorg/qiyi/basecore/card/model/statistics/CardStatistics;Ljava/util/List;Lorg/qiyi/basecore/card/CardModelHolder;)V

    goto :goto_1

    :pswitch_5
    new-instance v0, Lcom/qiyi/card/viewmodel/MovieTwoHotWordCardModel2;

    iget-object v1, p2, Lorg/qiyi/basecore/card/model/Card;->statistics:Lorg/qiyi/basecore/card/model/statistics/CardStatistics;

    invoke-direct {v0, v1, p3, p4}, Lcom/qiyi/card/viewmodel/MovieTwoHotWordCardModel2;-><init>(Lorg/qiyi/basecore/card/model/statistics/CardStatistics;Ljava/util/List;Lorg/qiyi/basecore/card/CardModelHolder;)V
...
.method public static getInstance(Z)Lorg/qiyi/basecore/card/builder/IOptCardBuilder;
    ...
    sget-object v0, Lcom/qiyi/card/builder/MovieHotWordCardBuilder;->instance:Lorg/qiyi/basecore/card/builder/IOptCardBuilder;
...
.method protected onCreateOriginalCardItems(Lorg/qiyi/basecore/card/CardModelHolder;Lorg/qiyi/basecore/card/model/Card;Lorg/qiyi/basecore/card/CardMode;Lorg/qiyi/basecore/card/builder/BuilderAttachment;)Ljava/util/List;
    ...
    invoke-direct {p0, v6, p2, v8, p1}, Lcom/qiyi/card/builder/MovieHotWordCardBuilder;->getCardModelBytype(Ljava/lang/String;Lorg/qiyi/basecore/card/model/Card;Ljava/util/List;Lorg/qiyi/basecore/card/CardModelHolder;)Lcom/qiyi/card/viewmodel/MovieHotWordCardModel;
    ...
    invoke-virtual {v4, v6}, Lcom/qiyi/card/viewmodel/MovieHotWordCardModel;->setLineRatioType(Ljava/lang/String;)V
    ...
    invoke-direct {p0, v4, p2, v6, p1}, Lcom/qiyi/card/builder/MovieHotWordCardBuilder;->getCardModelBytype(Ljava/lang/String;Lorg/qiyi/basecore/card/model/Card;Ljava/util/List;Lorg/qiyi/basecore/card/CardModelHolder;)Lcom/qiyi/card/viewmodel/MovieHotWordCardModel;
    :try_end_0
    ...
    iget-object v1, p2, Lorg/qiyi/basecore/card/model/Card;->bottom_banner:Lorg/qiyi/basecore/card/model/CardBottomBanner;
    ...
    :cond_5
    iget-object v1, p2, Lorg/qiyi/basecore/card/model/Card;->top_banner:Lorg/qiyi/basecore/card/model/CardTopBanner;
