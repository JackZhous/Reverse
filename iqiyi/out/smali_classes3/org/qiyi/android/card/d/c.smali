.class Lorg/qiyi/android/card/d/c;
...
# direct methods
.method constructor <init>(Lorg/qiyi/android/card/d/lpt6;Ljava/util/List;Lorg/qiyi/basecard/v3/adapter/ICardAdapter;Lorg/qiyi/basecard/v3/event/EventData;Lorg/qiyi/basecard/v3/viewholder/AbsViewHolder;)V
    .locals 0

    iput-object p1, p0, Lorg/qiyi/android/card/d/c;->gyv:Lorg/qiyi/android/card/d/lpt6;

    iput-object p2, p0, Lorg/qiyi/android/card/d/c;->val$modelList:Ljava/util/List;

    iput-object p3, p0, Lorg/qiyi/android/card/d/c;->val$adapter:Lorg/qiyi/basecard/v3/adapter/ICardAdapter;

    iput-object p4, p0, Lorg/qiyi/android/card/d/c;->val$eventData:Lorg/qiyi/basecard/v3/event/EventData;

    iput-object p5, p0, Lorg/qiyi/android/card/d/c;->val$viewHolder:Lorg/qiyi/basecard/v3/viewholder/AbsViewHolder;
...
.method public onBuildResult(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lorg/qiyi/android/card/d/c;->val$modelList:Ljava/util/List;
    ...
    iget-object v5, p0, Lorg/qiyi/android/card/d/c;->val$adapter:Lorg/qiyi/basecard/v3/adapter/ICardAdapter;
    ...
    iget-object v5, p0, Lorg/qiyi/android/card/d/c;->val$modelList:Ljava/util/List;
    ...
    :cond_1
    iget-object v0, p0, Lorg/qiyi/android/card/d/c;->val$adapter:Lorg/qiyi/basecard/v3/adapter/ICardAdapter;

    invoke-interface {v0}, Lorg/qiyi/basecard/v3/adapter/ICardAdapter;->notifyDataChanged()V

    iget-object v0, p0, Lorg/qiyi/android/card/d/c;->val$eventData:Lorg/qiyi/basecard/v3/event/EventData;
    ...
    :goto_2
    iget-object v2, p0, Lorg/qiyi/android/card/d/c;->val$eventData:Lorg/qiyi/basecard/v3/event/EventData;
    ...
    iget-object v1, p0, Lorg/qiyi/android/card/d/c;->val$viewHolder:Lorg/qiyi/basecard/v3/viewholder/AbsViewHolder;
