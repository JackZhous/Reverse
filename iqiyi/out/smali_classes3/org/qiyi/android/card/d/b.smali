.class Lorg/qiyi/android/card/d/b;
...
# direct methods
.method constructor <init>(Lorg/qiyi/android/card/d/lpt6;Ljava/util/List;Lorg/qiyi/basecard/v3/viewmodelholder/CardModelHolder;Lorg/qiyi/basecard/v3/adapter/ICardAdapter;Lorg/qiyi/basecard/v3/event/EventData;Lorg/qiyi/basecard/v3/viewholder/AbsViewHolder;)V
    .locals 0

    iput-object p1, p0, Lorg/qiyi/android/card/d/b;->gyv:Lorg/qiyi/android/card/d/lpt6;

    iput-object p2, p0, Lorg/qiyi/android/card/d/b;->val$modelList:Ljava/util/List;

    iput-object p3, p0, Lorg/qiyi/android/card/d/b;->val$holder:Lorg/qiyi/basecard/v3/viewmodelholder/CardModelHolder;

    iput-object p4, p0, Lorg/qiyi/android/card/d/b;->val$adapter:Lorg/qiyi/basecard/v3/adapter/ICardAdapter;

    iput-object p5, p0, Lorg/qiyi/android/card/d/b;->val$eventData:Lorg/qiyi/basecard/v3/event/EventData;

    iput-object p6, p0, Lorg/qiyi/android/card/d/b;->val$viewHolder:Lorg/qiyi/basecard/v3/viewholder/AbsViewHolder;
...
.method public onBuildResult(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lorg/qiyi/android/card/d/b;->val$modelList:Ljava/util/List;
    ...
    iget-object v2, p0, Lorg/qiyi/android/card/d/b;->val$holder:Lorg/qiyi/basecard/v3/viewmodelholder/CardModelHolder;
    ...
    iget-object v4, p0, Lorg/qiyi/android/card/d/b;->val$modelList:Ljava/util/List;

    invoke-interface {v4, v1, v0}, Ljava/util/List;->add(ILjava/lang/Object;)V

    iget-object v4, p0, Lorg/qiyi/android/card/d/b;->val$adapter:Lorg/qiyi/basecard/v3/adapter/ICardAdapter;
    ...
    :cond_0
    iget-object v0, p0, Lorg/qiyi/android/card/d/b;->val$adapter:Lorg/qiyi/basecard/v3/adapter/ICardAdapter;

    invoke-interface {v0}, Lorg/qiyi/basecard/v3/adapter/ICardAdapter;->notifyDataChanged()V

    iget-object v0, p0, Lorg/qiyi/android/card/d/b;->val$eventData:Lorg/qiyi/basecard/v3/event/EventData;
    ...
    :goto_2
    iget-object v2, p0, Lorg/qiyi/android/card/d/b;->val$eventData:Lorg/qiyi/basecard/v3/event/EventData;
    ...
    iget-object v1, p0, Lorg/qiyi/android/card/d/b;->val$viewHolder:Lorg/qiyi/basecard/v3/viewholder/AbsViewHolder;
