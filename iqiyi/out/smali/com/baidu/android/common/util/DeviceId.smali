...
.field private static final CONFIG_WRITE_V1_STORAGE:Z = true
...
.method private getCUIDInfo()Lcom/baidu/android/common/util/DeviceId$CUIDInfo;
    ...
    invoke-static {}, Lcom/baidu/android/common/Galaxy;->isCuidAppShareEnable()Z
    ...
    invoke-direct {p0, v0, v3}, Lcom/baidu/android/common/util/DeviceId;->collectBuddyInfos(Landroid/content/Intent;Z)Ljava/util/List;
    ...
    const-string/jumbo v4, "galaxy lib host missing meta-data,make sure you know the right way to integrate galaxy"
    ...
    iget-object v4, p0, Lcom/baidu/android/common/util/DeviceId;->mContext:Landroid/content/Context;
    ...
    invoke-direct {v2, v5}, Lcom/baidu/android/common/util/DeviceId$CUIDInfo;-><init>(Lcom/baidu/android/common/util/DeviceId$1;)V
    ...
    invoke-direct {p0, v2, v5}, Lcom/baidu/android/common/util/DeviceId;->tryPutSystemSettingValue(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string/jumbo v4, "backups/.SystemConfig/.cuid2"
...
.method private getExternalV1DeviceId(Ljava/lang/String;)Lcom/baidu/android/common/util/DeviceId$CUIDInfo;
    ...
    sget-object v6, Lcom/baidu/android/common/util/DeviceId;->AES_KEY:Ljava/lang/String;

    sget-object v7, Lcom/baidu/android/common/util/DeviceId;->AES_KEY:Ljava/lang/String;
...
.method private writeToCuidFile(Ljava/lang/String;)Z
    ...
    invoke-static {v1, v0}, Lcom/baidu/android/common/util/DeviceId$TargetApiSupport;->doChmodSafely(Ljava/lang/String;I)Z
