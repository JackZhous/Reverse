.class public Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;
...
.field private iWa:Lorg/qiyi/card/v3/block/blockmodel/Block11Model;
...
.method public constructor <init>(Landroid/view/View;Lorg/qiyi/pluginlibrary/utils/ResourcesToolForPlugin;)V
    ...
    invoke-virtual {p0, v0}, Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;->findViewByIdString(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lorg/qiyi/basecard/common/widget/ButtonView;

    iput-object v0, p0, Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;->iVZ:Lorg/qiyi/basecard/common/widget/ButtonView;
    ...
    iput-object v0, p0, Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;->mLayout:Landroid/widget/LinearLayout;
...
.method public a(Lorg/qiyi/basecard/v3/helper/ICardHelper;)V
    ...
    iput-object p1, p0, Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;->helper:Lorg/qiyi/basecard/v3/helper/ICardHelper;

    return-void
.end method

.method public a(Lorg/qiyi/card/v3/block/blockmodel/Block11Model;)V
    .locals 0

    iput-object p1, p0, Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;->iWa:Lorg/qiyi/card/v3/block/blockmodel/Block11Model;
...
.method public handleBlock11MessageEvent(Lorg/qiyi/card/v3/d/con;)V
    ...
    iget-object v0, p0, Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;->blockModel:Lorg/qiyi/basecard/v3/viewmodel/block/AbsBlockModel;
    ...
    iget-object v0, p0, Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;->metaViewList:Ljava/util/List;
    ...
    iget-object v0, p0, Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;->iWa:Lorg/qiyi/card/v3/block/blockmodel/Block11Model;

    invoke-virtual {v0}, Lorg/qiyi/card/v3/block/blockmodel/Block11Model;->getBlock()Lorg/qiyi/basecard/v3/data/component/Block;
    ...
    iget-object v1, p0, Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;->iWa:Lorg/qiyi/card/v3/block/blockmodel/Block11Model;

    invoke-virtual {v1}, Lorg/qiyi/card/v3/block/blockmodel/Block11Model;->getBlock()Lorg/qiyi/basecard/v3/data/component/Block;
    ...
    invoke-static {v0, v1}, Lorg/qiyi/card/v3/block/blockmodel/Block11Model;->a(Lorg/qiyi/card/v3/block/blockmodel/Block11Model;Ljava/lang/String;)V

    iget-object v0, p0, Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;->iWa:Lorg/qiyi/card/v3/block/blockmodel/Block11Model;

    iget-object v1, p0, Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;->parentHolder:Lorg/qiyi/basecard/v3/viewholder/AbsBlockRowViewHolder;

    iget-object v2, p0, Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;->helper:Lorg/qiyi/basecard/v3/helper/ICardHelper;

    invoke-virtual {v0, v1, p0, v2}, Lorg/qiyi/card/v3/block/blockmodel/Block11Model;->a(Lorg/qiyi/basecard/v3/viewholder/RowViewHolder;Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;Lorg/qiyi/basecard/v3/helper/ICardHelper;)V
    :try_end_1
...
.method protected initImages()V
    ...
    iput-object v0, p0, Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;->imageViewList:Ljava/util/List;
    ...
    iget-object v2, p0, Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;->imageViewList:Ljava/util/List;
...
.method protected initMetas()V
    ...
    iput-object v0, p0, Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;->metaViewList:Ljava/util/List;
    ...
    iget-object v2, p0, Lorg/qiyi/card/v3/block/blockmodel/Block11Model$ViewHolder;->metaViewList:Ljava/util/List;
