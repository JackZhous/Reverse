.class final Landroid/support/multidex/com1;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/multidex/com1;->dk:Ljava/lang/reflect/Method;
    :try_end_0
...
.method private static a(Landroid/content/Context;JJI)V
    ...
    invoke-static {p0}, Landroid/support/multidex/com1;->getMultiDexPreferences(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    invoke-static {v0}, Landroid/support/multidex/com1;->apply(Landroid/content/SharedPreferences$Editor;)V
...
.method private static apply(Landroid/content/SharedPreferences$Editor;)V
    ...
    sget-object v0, Landroid/support/multidex/com1;->dk:Ljava/lang/reflect/Method;
...
.method private static extract(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v1}, Landroid/support/multidex/com1;->closeQuietly(Ljava/io/Closeable;)V
...
.method private static getZipCrc(Ljava/io/File;)J
    ...
    invoke-static {p0}, Landroid/support/multidex/com3;->getZipCrc(Ljava/io/File;)J
...
.method private static isModified(Landroid/content/Context;Ljava/io/File;J)Z
    ...
    invoke-static {p1}, Landroid/support/multidex/com1;->getTimeStamp(Ljava/io/File;)J
...
.method static load(Landroid/content/Context;Landroid/content/pm/ApplicationInfo;Ljava/io/File;Z)Ljava/util/List;
    ...
    invoke-static {v1}, Landroid/support/multidex/com1;->getZipCrc(Ljava/io/File;)J

    move-result-wide v4

    if-nez p3, :cond_0

    invoke-static {p0, v1, v4, v5}, Landroid/support/multidex/com1;->isModified(Landroid/content/Context;Ljava/io/File;J)Z
    ...
    :try_start_0
    invoke-static {p0, v1, p2}, Landroid/support/multidex/com1;->loadExistingExtractions(Landroid/content/Context;Ljava/io/File;Ljava/io/File;)Ljava/util/List;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v1, p2}, Landroid/support/multidex/com1;->performExtractions(Ljava/io/File;Ljava/io/File;)Ljava/util/List;

    move-result-object v0

    invoke-static {v1}, Landroid/support/multidex/com1;->getTimeStamp(Ljava/io/File;)J
    ...
    invoke-static/range {v1 .. v6}, Landroid/support/multidex/com1;->a(Landroid/content/Context;JJI)V
...
.method private static loadExistingExtractions(Landroid/content/Context;Ljava/io/File;Ljava/io/File;)Ljava/util/List;
    ...
    invoke-static {v5}, Landroid/support/multidex/com1;->verifyZipFile(Ljava/io/File;)Z
...
.method private static performExtractions(Ljava/io/File;Ljava/io/File;)Ljava/util/List;
    ...
    invoke-static {p1, v6}, Landroid/support/multidex/com1;->prepareDexDir(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8, v4, v9, v6}, Landroid/support/multidex/com1;->extract(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V

    invoke-static {v9}, Landroid/support/multidex/com1;->verifyZipFile(Ljava/io/File;)Z
...
.method private static prepareDexDir(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v0}, Landroid/support/multidex/com1;->mkdirChecked(Ljava/io/File;)V

    invoke-static {p0}, Landroid/support/multidex/com1;->mkdirChecked(Ljava/io/File;)V

    new-instance v0, Landroid/support/multidex/com2;

    invoke-direct {v0, p1}, Landroid/support/multidex/com2;-><init>(Ljava/lang/String;)V
